...
# SCHEDULE_FILES list is removed
...
@st.cache_data
def load_and_clean_schedule(file_path): # <-- Removed is_stats_file
    try:
        ...
        # Only show error if the *main* schedule file is missing
        if file_path == SCHEDULE_FILE_NAME:
